...
const TvDetails = () => {
   document.title = "Movie Genie | Tv Show Details";
   ...
   return info ? (
      <div
         style={{
            background: `linear-gradient(rgba(0,0,0,.3),rgba(0,0,0,.8), rgba(0,0,0,.8)), url(https://image.tmdb.org/t/p/original/${info.detail.backdrop_path})`,
